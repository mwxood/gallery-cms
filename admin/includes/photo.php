<?php
  ...
  class Photo extends Db_object {
    ...
    protected static $db_table_fields = array('photo_id', 'title', 'caption', 'description', 'filename', 'alternate_text', 'type', 'size', 'date') ;
    public $id;
    public $title;
    public $caption;
    public $description;
    ...
    public static function display_sidebar_data($photo_id) {
      ...
      $output = "<a class'thumbnail' href='javascript:;'><img width='100' src='{$photo->picture_path()}' /></a>";

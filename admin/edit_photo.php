        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="edit_photo.php?id=<?= $photo->id; ?>" method="post">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <a class="thumbnail" href="#"> <img src="<?= $photo->picture_path(); ?>" alt="<?= $photo->title; ?>"></a>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="editor" rows="8" cols="80" class="form-control">
                                      <?= $photo->description; ?>
                                    </textarea>
                                </div>
